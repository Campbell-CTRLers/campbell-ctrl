...
export const AboutSection = ({ content, siteContent = null, setSiteContent, contentEditor }) => {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <EditableSiteText as="h2" contentKey="about.heading" fallback={heading} siteContent={siteContent} setSiteContent={setSiteContent} editor={contentEditor} className="font-sans font-bold text-3xl md:text-4xl text-primary mb-4 tracking-tight" />
        <EditableSiteText as="p" contentKey="about.description" fallback={description} siteContent={siteContent} setSiteContent={setSiteContent} editor={contentEditor} className="font-roboto text-slate/80 text-lg md:text-xl leading-relaxed mb-12" />
          ...
          {cards.map((card, i) => {
            ...
            return (
              ...
              >
                ...
                <EditableSiteText as="h3" contentKey={`about.cards.${i}.title`} fallback={card.title} siteContent={siteContent} setSiteContent={setSiteContent} editor={contentEditor} className="font-sans font-bold text-lg text-primary" />
                <EditableSiteText as="p" contentKey={`about.cards.${i}.desc`} fallback={card.desc} siteContent={siteContent} setSiteContent={setSiteContent} editor={contentEditor} className="font-roboto text-slate/70 text-sm leading-relaxed" />
              </div>
            );
          })}
        </div>
